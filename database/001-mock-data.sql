...
values ('Alfonzo', 'Bonzo', 'user1@example.com', 'DISABLED', 1, 'BAPTISEDBRO', 'ADMIN', 0, 0);
...
values
    ('Test event', 'Glasgow Hydro', '2017-07-15', '2017-07-18', 'COMPLETED', 0, 0),
    ('Test event', 'Glasgow Hydro', '2018-06-01', '2018-06-03', 'ANNOUNCED', 0, 0);
